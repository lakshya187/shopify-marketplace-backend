...
export const BASIC_AUTH_SCOPE = `read_products, write_products, read_inventory, read_orders, write_orders,`;
export const INTERNAL_STORES = ["anilambanistore.myshopify.com"];
